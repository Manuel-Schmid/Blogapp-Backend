...
def token_auth(f: Any) -> Coroutine:  # noqa: ANN401
    async def wrapper_async(cls: Any, info: Info, password: str, **kwargs: Any) -> Coroutine:  # noqa: ANN401
    ...
    @csrf_rotation
    @refresh_expiration
    def wrapper(cls: Any, info: Info, password: str, **kwargs: Any) -> Coroutine:  # noqa: ANN401
        context = get_context(info)
